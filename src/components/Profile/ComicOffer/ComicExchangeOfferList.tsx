      ...
      {comicExchangeOffer.length > 0 ? (
        <div className="flex flex-col">
          {comicExchangeOffer.map((comic) => {
            const countTime = moment(comic.createdAt).fromNow();
            return (
              <div
                key={comic.id}
                className="border p-4 rounded-lg shadow-sm flex flex-row gap-8 mb-4"
              >
                <img
                ...
                <div className="flex flex-col gap-2 w-full">
                  <div className="flex flex-col w-full p-4 gap-1 rounded-xl bg-white drop-shadow-md">
                    ...
                    <h3 className="font-bold text-2xl">{comic.title}</h3>
                    <p className="font-light text-sm italic">{countTime}</p>
