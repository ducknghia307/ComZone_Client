          ...
          <Table sx={{ minWidth: 700 }} aria-label="customized table">
            <TableHead>
              <TableRow>
                ...
                <StyledTableCell align="right" style={{ whiteSpace: 'nowrap' }}>Giá</StyledTableCell>
              ...
              {loading ? (
                ...
                filteredComics.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((comic) => (
                  <StyledTableRow key={comic.id}>
                    <StyledTableCell>
                      <img style={{ width: '40px', height: '60px' }} src={comic.coverImage} alt={comic.title} />
                    </StyledTableCell>
                    <StyledTableCell>{comic.title}</StyledTableCell>
                    <StyledTableCell align="right">{comic.price}</StyledTableCell>
