...
const ComicAuction = () => {
  ...
  return (
    <div className="auction-wrapper">
      <div className="title-container" style={{ borderBottom: '1px solid #ccc' }}>
        <Typography
          style={{
            paddingLeft: "50px",
            fontSize: "23px",
        ...
        <div className="condition-tag" style={{ fontFamily: "REM", textShadow: '3px 3px #000', fontSize: "23px" }}>
      ...
      <Grid container spacing={3} className="auction-container">
        ...
        <Grid size={5} className="auction-info">
          <div className="timer">
            <p style={{ fontFamily: "REM", fontSize: '20px', paddingBottom: '15px' }}>KẾT THÚC VÀO: {formatEndTime(auctionData.endTime)}</p>
            <CountdownFlipNumbers endTime={auctionData.endTime} />

            <div className="current-price" style={{ display: "flex", justifyContent: "space-around", padding: '10px 15px' }}>
              <div className="current-price1" style={{ display: "flex", alignItems: 'center', gap: '10px' }}>
                <p style={{ fontFamily: "REM", paddingBottom: '0', fontSize: '18px' }}>Giá hiện tại:</p>
                <CountUp
                  style={{ fontFamily: "REM", fontSize: '28px', fontWeight: 'bold', textShadow: '4px 4px #000' }}
                  start={
          ...
          <div className="shop-info">
            <Chip
              avatar={<Avatar src={users?.avatar} alt="Vendor Avatar" style={{ width: '30px', height: '30px' }} />}
              label={
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '16px', paddingLeft: '5px' }}>
                  {users?.name}
                  <StoreOutlinedIcon style={{ fontSize: '24px', color: '#000' }} />
                </div>
              }
              style={{
                fontFamily: "REM",
            ...
            <p style={{ fontSize: "17px", paddingTop: "10px", fontFamily: "REM", fontWeight: '400' }}>
              Giá đấu tối thiểu tiếp theo:{" "}
              {auctionData && (
                <span style={{ fontWeight: "bold" }}>
                  {(auctionData.currentPrice + auctionData.priceStep).toLocaleString("vi-VN")}đ
                </span>
              )}
            </p>
          ...
          <div className="publisher">
            ...
            <div style={{ display: 'flex', alignItems: 'center', marginTop: '15px' }}>
              <p style={{ fontSize: "17px", fontFamily: "REM", fontWeight: '400', marginRight: '10px' }}>
                Phiên Bản:
              </p>
              <Chip
                ...
                style={{
                  ...
                  fontWeight: 'bold',
                  padding: '18px 10px',
                  backgroundColor: comic.edition === 'REGULAR' ? '#fff' : '#000', 
