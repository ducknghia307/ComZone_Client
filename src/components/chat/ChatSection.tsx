...
export default function ChatSection({
  ...
  return (
    <div className={`w-1/2 relative px-4 border-r border-gray-300`}>
      <div className="top-0 sticky flex items-center justify-between gap-4 drop-shadow-xl">
        <div className="flex items-center gap-4">
          ...
          <span className="text">
            ...
            <p className="text-xs font-light">
              Hoạt động {moment(chatRoom?.secondUser.lastActive).fromNow()}
            </p>
          </span>
        </div>
