...
const DeliveryAddress = () => {
  ...
  const [selectedAddress, setSelectedAddress] = useState("comzone");
    ...
    <div className=" w-full bg-white px-8 py-4 rounded-lg">
      <div className="flex flex-row justify-between w-full">
        ...
        <Modal
          title={
            <>
              {newAddress ? (
                <div className="flex flex-row px-4 mt-6 items-center gap-5">
                  <button
                  ...
                  <h3 className="REM text-xl">THÊM ĐỊA CHỈ MỚI</h3>
                </div>
              ) : (
                <div className="flex flex-row justify-between px-4 mt-4 items-center">
                  <h3 className="REM text-xl">CHỌN THÔNG TIN GIAO HÀNG</h3>
                  <button
                    className="bg-green-500 py-2 px-4 rounded-2xl text-white REM "
                    onClick={() => setNewAddress(!newAddress)}
                  >
                    + Tạo thông tin mới
                  </button>
              ...
              <>
                <div
                  className={`w-full p-4 mb-4 rounded-lg border h-28 ${
                    selectedAddress === "comzone"
                      ? "border-black border-2"
                      : "border-gray-300"
                  } flex items-center justify-between`}
                  onClick={() => setSelectedAddress("comzone")}
                >
                  <div className="flex items-center">
                    <input
                      ...
                      id="comzone"
                      name="payment"
                      checked={selectedAddress === "comzone"}
                      onChange={() => setSelectedAddress("comzone")}
                      className="mr-4"
                    />
                    <div className="flex flex-col gap-1 w-full">
                      <div className="flex flex-row w-full gap-5 items-center">
                        ...
                        <div className="flex flex-row gap-3">
                          ...
                          <h3>|</h3>
                          <h3 className="font-light">{userInfo?.phone}</h3>
                        </div>
                      </div>
                      <div className="flex flex-row gap-5 mt-2">
                        ...
                        <div className="flex flex-col gap-1">
                          <h3 className="font-light">
                            1137/29/3 Nguyễn Phạm Lê Trần
                          </h3>
                          <h3 className="font-light">
                            Phường Nhà Văn Hóa, Thành phố Dĩ An, Tỉnh Bình Dương
                          </h3>
                        </div>
                      </div>
                    </div>
      ...
      <div className="flex flex-col w-full mt-3">
        ...
        <div className="flex flex-row gap-5 mt-2">
          ...
          <div className="flex flex-col gap-1">
            <h3 className="font-light">1137/29/3 Nguyễn Phạm Lê Trần</h3>
            <h3 className="font-light">
              Phường Nhà Văn Hóa, Thành phố Dĩ An, Tỉnh Bình Dương
            </h3>
          </div>
