    ...
    if (accessToken) {
      try {
        ...
        const existingComicIndex = currentCart.findIndex(
          (item: { comics: Comic }) => item.comics.id === comicId
        );
        ...
        if (existingComicIndex >= 0) {
          ...
          console.log("Item added to cart:", comicId);
          ...
          <Grid size={{ xs: 7 }} className="detail-frame">
            ...
            <div className="detail2">
              ...
              <Typography className="note">
                Giá sản phẩm trên ComZone đã bao gồm thuế theo luật hiện hành.
                Bên cạnh đó, tuỳ vào loại sản phẩm, hình thức và địa chỉ giao
                hàng mà có thể phát sinh thêm chi phí khác như: Phụ phí đóng
                ...
                <div className="review-header">
                  ...
                  <div className="user-info">
                    ...
                    <div className="review-content">
                      <Typography>
                        Truyện này quá tuyệt, cốt truyện hấp dẫn và hình ảnh
                        minh họa đẹp.
                      </Typography>
                    </div>
                  </div>
