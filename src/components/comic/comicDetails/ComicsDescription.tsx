...
export default function ComicsDescription({
  ...
  return (
    <div className="relative w-full flex flex-col gap-2 bg-white px-4 py-4 rounded-xl drop-shadow-md">
      <p className="text-base font-bold pb-2">Mô tả truyện</p>

      <div
        className={`font-light ${
          isShowingLess ? "max-h-40 overflow-hidden" : "max-h-fit"
        } leading-relaxed`}
        style={{ fontSize }} // Apply the fontSize from props here
      >
      ...
      <button
        ...
        className={`absolute bottom-0 left-1/2 transform -translate-x-1/2 w-full rounded-xl ${
          isShowingLess
