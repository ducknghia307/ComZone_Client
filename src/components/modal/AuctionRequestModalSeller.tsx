...
interface AuctionDetailModalProps {
  ...
  auctionRequest: {
    ...
    priceStep: number;
    duration: number;
    rejectionReason: string[]; // Updated to an array
  };
}
...
const AuctionRequestModalSeller: React.FC<AuctionDetailModalProps> = ({
  ...
  console.log("12", auctionRequest.rejectionReason);
        ...
        >
          ...
          <div style={{ flex: 1, padding: "15px" }}>
            ...
            {[
              ...
              >
                <Typography
                  style={{ color: "#666", fontWeight: 500, fontFamily: "REM" }}
                >
                  {label}
                </Typography>
                <Typography
            ...
            {/* Only display rejection reason if the status is 'REJECTED' */}
            {auctionRequest.status === "REJECTED" && (
              ...
              >
                ...
                >
                  {auctionRequest.rejectionReason?.length ? (
                    <ul
                      style={{
                        backgroundColor: "#ffebee",
                        color: "#d32f2f",
                    ...
                    >
                      {auctionRequest.rejectionReason.map((reason, index) => (
