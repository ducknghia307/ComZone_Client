...
import {
    Button, Dialog, DialogContent, DialogTitle, FormControlLabel, IconButton,
    Radio, RadioGroup, Rating, TextField, Typography
} from '@mui/material';
        ...
        >
            ...
            <DialogContent sx={{ padding: '0px 60px 40px 60px' }}>
                <div style={{ display: 'flex', alignItems: 'flex-start' }}>
                    <Typography sx={{ fontSize: '18px', fontWeight: 'bold', marginRight: '8px' }}>
                        Tên truyện:
                    </Typography>
                    <div style={{ display: 'flex', flexDirection: 'column' }}>
                        <Typography sx={{ fontSize: '18px' }}>Thám Tử Lừng Danh Conan - Tập 102 (x1)</Typography>
                        <Typography sx={{ fontSize: '18px' }}>Thám Tử Lừng Danh Conan - Tập 1 (x1)</Typography>
                        <Typography sx={{ fontSize: '18px' }}>Thám Tử Lừng Danh Conan - Tập 2 (x1)</Typography>
                    </div>
                </div>

                <div style={{ display: 'flex', marginTop: '10px' }}>
                    <Typography sx={{ fontSize: '18px', fontWeight: 'bold', marginRight: '8px' }}>Mã đơn hàng:</Typography>
                ...
                <div style={{ display: 'flex', gap: '10px', marginTop: '15px', alignItems: 'center' }}>
                    <Typography sx={{ fontSize: '18px', fontWeight: 'bold' }}>Đánh giá người bán:</Typography>
                    <RadioGroup
                        row
                        value={isSellerRated}
