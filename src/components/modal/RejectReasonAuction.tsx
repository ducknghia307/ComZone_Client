    ...
    <Dialog open={open} onClose={onCancel} maxWidth="sm" fullWidth>
      ...
      <DialogContent>
        <Box>
            ...
            <FormControlLabel
              ...
              label={
                <Typography sx={{ fontFamily: "REM", fontSize: "14px" }}>
                  Các ảnh đính kèm không đầy đủ hoặc không phù hợp với phiên bản
                  truyện mà người bán đã chọn.
                </Typography>
              }
            />
            <FormControlLabel
          ...
          <Typography
            sx={{ fontFamily: "REM", fontSize: "14px", marginTop: "8px" }}
          >
            Lý do khác:
          </Typography>
          <Input.TextArea
