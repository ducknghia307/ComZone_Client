...
import { Badge, Dropdown, notification, Popover, Tooltip } from "antd";
                  ...
                  {userInfo ? (
                    <div className="flex flex-row">
                      <div className="flex flex-row justify-center items-center lg:gap-6 md:gap-4 sm:gap-2 w-full">
                        ...
                        >
                          <Link
                            className="px-6 hover:text-black md:flex lg:flex hidden"
          ...
          {menuOpen && (
            <div className="lg:hidden flex flex-col w-full mt-4 absolute top-0 left-0 bg-white z-10">
              ...
              <div className="flex flex-col items-center w-full">
                ...
                <Link
                  className={`text-black px-6 py-2 hover:text-black flex lg:hidden mb-2 md:hidden ${
