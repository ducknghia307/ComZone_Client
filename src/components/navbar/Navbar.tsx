...
import { Badge, Divider, Dropdown, notification, Popover, Tooltip } from "antd";
        ...
        <div className=" flex flex-col  items-center py-4 REM list-none w-full lg:px-12 px-8 max-w-full ">
          <div className="flex items-center w-full flex-row min-w-max">
            ...
            <div className="px-4 max-w-64">
              {window.location.pathname !== "/signin" &&
                ...
                window.location.pathname !== "/forgot" && (
                  <Link to={"/"}>
                    <img
                      className="w-32 md:w-48 lg:w-full object-cover min-w-32"
                      src={Logo}
                      alt="ComZone"
                    />
                  </Link>
            ...
            {window.location.pathname !== "/signin" &&
              window.location.pathname !== "/signup" &&
              window.location.pathname !== "/forgot" && (
                <div className="flex items-center lg:w-full lg:flex lg:relative grow md:justify-end sm:justify-end">
                  ...
                  {userInfo ? (
                    <div className="flex flex-row">
                      <div className="flex flex-row justify-center items-center lg:gap-6 md:gap-4 sm:gap-2 w-full">
                        <Tooltip
                          title={
                            <p className="REM text-black">Quản Lý Trao Đổi</p>
                          }
                          color="white"
                        >
                          <Link
                            to={"/exchange/list/all"}
                            className="items-center cursor-pointer duration-200 hover:opacity-50 ml-4 md:flex hidden"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 24 24"
                        ...
                        {/* Chat */}
                        <Tooltip
                          title={<p className="REM text-black">Chat</p>}
                          color="white"
                        >
                          <li
                            className="items-center cursor-pointer duration-200 hover:opacity-50 ml-4 flex"
                              ...
                              <li className="items-center cursor-pointer duration-200 hover:opacity-50 ml-4 sm:flex hidden">
                                ...
                                >
                                  <svg
                                    ...
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="w-8 lg:w-[40px] aspect-square"
                                  >
                                    <path
                        ...
                        <Tooltip
                          title={<p className="REM text-black">Giỏ hàng</p>}
                          color="white"
                        >
                          <Link
                            className="px-6 hover:text-black sm:flex hidden"
                            to={userInfo ? "/cart" : "/signin"}
                          >
                            <Badge
                              count={userInfo ? cartLength : 0}
                              color="black"
                            >
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                      ...
                      <button
                        className="ml-2 border p-1 rounded-lg md:hidden lg:hidden"
                        onClick={toggleMenu}
                      >
                        <svg
                          width="28px"
          ...
          {menuOpen && (
            <div className="lg:hidden flex flex-col w-full mt-4 absolute top-0 left-0 bg-white z-10">
              ...
              <div className="flex flex-col items-center w-full pb-4">
                ...
                {userInfo?.role === "SELLER" && (
                  <Link
                    to="/sellermanagement/shop-info"
                    className={`text-black px-6 py-2 hover:text-black flex lg:hidden md:hidden ${
                      location.pathname === "/sellermanagement/shop-info"
                        ? "font-bold"
                        : ""
                    }`}
                    onClick={toggleMenu}
                ...
                <Link
                  className={`text-black px-6 py-2 hover:text-black flex lg:hidden md:hidden ${
                    location.pathname === "/accountmanagement/profile"
                      ? "font-bold"
                      : ""
                  }`}
                ...
                <Link
                  className={`text-black px-6 py-2 hover:text-black flex lg:hidden md:hidden ${
                    location.pathname === "/exchange/list/all"
                      ? "font-bold"
                      : ""
                  }`}
                  to="/exchange/list/all"
                ...
                <button
                  className={`px-6 py-2 hover:text-black flex lg:hidden md:hidden text-red-600`}
                  onClick={handleLogout}
                >
                  ĐĂNG XUẤT
                </button>
