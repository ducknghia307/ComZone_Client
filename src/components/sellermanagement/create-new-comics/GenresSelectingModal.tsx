...
import { Genre } from "./MainComicsInformation";
  ...
  return (
    ...
    >
      <div className="space-y-4 pt-8">
        <p className="font-semibold text-xl uppercase">CHỌN THỂ LOẠI</p>
        ...
        <div className="flex flex-col sm:flex-row items-stretch gap-4">
          ...
          <div className="min-w-fit sm:basis-1/3 flex items-center justify-between gap-4">
            <p>
              Đã chọn:{" "}
              <span className="font-semibold">{selectedGenres.length} / 5</span>
            </p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 items-stretch gap-2">
